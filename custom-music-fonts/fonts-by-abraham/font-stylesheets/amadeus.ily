%%%% The stylesheet for AMADEUS music notation font
%%%%
...
% This is used to allow for local use of Amadeus
% (i.e., \override Staff.NoteHead.font-family = 'amadeus)
